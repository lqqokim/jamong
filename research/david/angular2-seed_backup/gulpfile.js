...
gulp.task('build.prod', function (done) {
    return runSequence('clean.prod', 'tslint', 'css-lint', 'build.assets.prod', 'build.html_css', 'copy.js.prod', 'build.js.prod', 'build.bundles', 'build.bundles.app', 'build.index.prod', done);
});
// --------------
// Build test.
gulp.task('build.test', function (done) {
    return runSequence('clean.dev', 'tslint', 'build.assets.dev', 'build.html_css', 'build.js.test', 'build.index.dev', done);
});
// --------------
// Build test watch.
